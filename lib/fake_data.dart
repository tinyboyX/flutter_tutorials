...
const FAKE_CATEGORIES = const [
  ...
  Category(id: 4, content: 'Vietnamese\'s Foods', color: Colors.deepPurpleAccent),
  Category(id: 5, content: 'Spagetti', color: Colors.lightGreenAccent),
  Category(id: 6, content: 'Sandwich', color: Colors.amber),
];
var FAKE_FOODS = [
